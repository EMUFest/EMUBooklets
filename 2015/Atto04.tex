...
\descrizione{On-y r\^eve}{Il brano è una “rappresentazione notturna” per pianoforte e nastro pervasa da sonorità ed atmosfere sospese, tipiche delle visioni oniriche.  La scrittura pianistica mantiene un carattere rapsodico, mentre la componente elettronica filtra ed estende le risonanze del pedale tonale prodotte dallo strumento e restituisce elaborazioni granulari di pianoforte preparato. Un gioco di luci ed ombre rimanda ad un contrappunto di chiaroscuri, dove ogni tassello viene costruito attraverso manipolazioni e ricomposizioni di materiali ricavati dal \textit{Poème-Nocturne} op. 61 di Alexander Scriabin, del quale ricorre quest’anno il centenario della scomparsa.}
...
\center{\begin{pspicture}(1in,1in)
	\psbarcode{https://goo.gl/i8BBwD}{eclevel=L width=1 height=1}{qrcode}
\end{pspicture}}\footnote{https://goo.gl/i8BBwD}
